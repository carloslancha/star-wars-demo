...
@Component(
	...
	property = {
		...
		"mvc.command.name=add_character"
	},
	service = MVCActionCommand.class
)
public class StarWarsDemoAddCharacterMVCActionCommand
	...
	protected void doProcessAction(
		...
		try {
			...
			ServiceContext serviceContext = ServiceContextFactory.getInstance(
				StarWarsCharacter.class.getName(), actionRequest);

			_starWarsCharacterService.addStarWarsCharacter(
				themeDisplay.getScopeGroupId(), name, picture, fraction,
