...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=starwars", "json.web.service.context.path=StarWarsCharacter"}, service = StarWarsCharacterService.class)
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface StarWarsCharacterService extends BaseService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
